...
/*      int TempDividerMask, TempUserMode, i;
      TempDividerMask = 0xFF00;
      TempUserMode = (CNTL_PORT1 & (USM2_BIT + USM1_BIT + USM0_BIT)) >> 1;
      for (i = 7; i > 0; i --)
        {
        if (TempUserMode == i)
          {
      ...
      MS_Index &= TempDividerMask;
      MS_Divider = 1 << TempUserMode;*/
    }
}
